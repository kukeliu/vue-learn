          ...
          <el-row class="item-row" v-for="(item,index) in listdata">
            ...
            <el-col :span="19">
              <div class="head">
                ...
                <div style="color: black;">期刊文章：<a>全文在线</a></div>
                <div><a>更多信息</a></div>
              </div>
            </el-col>
          </el-row>
          <el-row class="item-row" v-for="(item,index) in downdata">
            <el-col :span="5" >
              <div class="head"><img src="../img/sgyy.jpg"></div>
            </el-col>
            <el-col :span="19">
              <div class="head">
  ...
  export default {
    ...
    methods:{
      getList() {
        ...
        for(let i = 0; i < 60; i++) {
          response.push({
            image: require('../img/sgyy.jpg'),
            content:this.remarkRed(this.content,"正在九年级物理中,\"浮力\"一 章是全书的重点和难点,阿基米德原理又是全章的一个核心,它贯穿全章的各个部分.一直到现在,还流传着阿基米德检验皇冠的故事,在阿基米德(公...）"),
            author:'《广东教育(综合版)》 , 2010 (5) :48-49'
          })
        }
      ...
      remarkRed:function (prop,content) {
        var reg = new RegExp("("+prop+")","g");
        var newContent = content.replace(reg,"<span class='keyword'>$1</span>");
        return newContent;
      }
    },
